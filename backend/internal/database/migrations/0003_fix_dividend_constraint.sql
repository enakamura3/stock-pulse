...
ALTER TABLE asset_event DROP CONSTRAINT IF EXISTS asset_event_asset_id_with_date_type_key;
ALTER TABLE asset_event DROP CONSTRAINT IF EXISTS asset_event_asset_id_cum_date_type_key;
